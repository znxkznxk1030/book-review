...
실패할 확률이 다소 높긴하지만 수학적으로 입증된 방법이니 최고의 비서를 찾는 방법으로 최고의 배우자를 찾아보는 것은 좋은 방법이긴 하지만 여기엔 비서문제와 다른 세가지 함정이 있다.  
...
현실속 결정문제는 다른 요소들이 추가 되어 복잡성은 훨씬 높아졌지만, 각 요소에도 확률을 적용해 볼 수 있고 최고의 배우자를 구하기 위한 방법을 수학적으로 도입해 볼 여지가 있다.
